...
public:
	HRESULT Initialize_Custom(const MeshBufferInitiaizeInfo _info, void* _desc);
...
public:
	...
	static _float SolveYOnPlane(const vector3& _n, _float _d, _float _x, _float _z, _float _fallbackY);
