...
HRESULT CRenderTarget::Ready_Debug(const vector2Int _pos, const vector2Int _size)
{
	...
	if (!m_pCBPerMaterial)
	{
		...
		bd.Usage = D3D11_USAGE_DEFAULT;
		bd.BindFlags = D3D11_BIND_CONSTANT_BUFFER;
		bd.ByteWidth = sizeof(MatCB); // 16����Ʈ ���
...
HRESULT CRenderTarget::Render()
{
	...
	// 3) ������� ������Ʈ (b0: world, b1: cam(view/proj), b2: material)
	...
	// 4) ���̴� / CB / SRV ���ε�
	m_pDefferdShader->Bind(); // VSMain/PSMain(�������) ���ε��ǵ���
...
void CRenderTarget::Bind_Rect()
{
	...
	// VS���� ortho P�� ���� �����Ƿ�,
	// ȭ���� �� ä����� (0,0) �������� vp.Width, vp.Height ũ��� �����ϸ� �ָ� �˴ϴ�.
