...
void CResources::Ready_GameResources()
{
	...
	CShader::SHADERDESC deferredShadowShaderDesc = { L"../EngineResources/Shader/DeferredShadowMask.hlsl", L"",  VertexTexColorBuffer::numElements, VertexTexColorBuffer::elementDesc };
	LoadResourceComplete_Game<CShader>(L"DeferredShadowMask (Shader)", L"", &deferredShadowShaderDesc);

	CShader* deferredShadowShader = LoadOnGame<CShader>(L"DeferredShadowMask (Shader)");
	CMaterial::MATERIALDESC deferredShadowMatDesc = { deferredShadowShader, true };
	LoadResourceComplete_Game<CMaterial>(L"DeferredShadowMask (Material)", L"", &deferredShadowMatDesc);
