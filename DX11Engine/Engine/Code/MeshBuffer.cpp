...
CMeshBuffer::MeshBufferInitiaizeInfo CMeshBuffer::CreateCube()
{
    ...
    {
        // 앞(-Z)  [Col 1, Row 1]  U 0.25~0.50 , V 0.333~0.666
        {{-l,-l,-l},{ 0,0,-1},{0,0},{1,0,0}},
        {{ l,-l,-l},{ 0,0,-1},{0.50f,0.666f},{1,0,0}},
        {{ l, l,-l},{ 0,0,-1},{0.50f,0.333f},{1,0,0}},
        {{-l, l,-l},{ 0,0,-1},{0.25f,0.333f},{1,0,0}},

        // 뒤(+Z)  [Col 0, Row 1]  U 0.00~0.25 , V 0.333~0.666
        {{ l,-l, l},{ 0,0, 1},{0.25f,0.666f},{-1,0,0}},
        {{-l,-l, l},{ 0,0, 1},{0.00f,0.666f},{-1,0,0}},
        {{-l, l, l},{ 0,0, 1},{0.00f,0.333f},{-1,0,0}},
        {{ l, l, l},{ 0,0, 1},{0.25f,0.333f},{-1,0,0}},

        // 왼(-X)   [Col 3, Row 1]  U 0.75~1.00 , V 0.333~0.666
        {{-l,-l, l},{-1,0,0},{0.75f,0.666f},{0,0,-1}},
        {{-l,-l,-l},{-1,0,0},{1.00f,0.666f},{0,0,-1}},
        {{-l, l,-l},{-1,0,0},{1.00f,0.333f},{0,0,-1}},
        {{-l, l, l},{-1,0,0},{0.75f,0.333f},{0,0,-1}},

        // 오른(+X) [Col 2, Row 1]  U 0.50~0.75 , V 0.333~0.666
        {{ l,-l,-l},{ 1,0,0},{0.50f,0.666f},{0,0,1}},
        {{ l,-l, l},{ 1,0,0},{0.75f,0.666f},{0,0,1}},
        {{ l, l, l},{ 1,0,0},{0.75f,0.333f},{0,0,1}},
        {{ l, l,-l},{ 1,0,0},{0.50f,0.333f},{0,0,1}},

        // 위(+Y)   [Col 1, Row 0]  U 0.25~0.50 , V 0.000~0.333
        { { -l,  l, -l }, { 0,  1, 0 }, { 0.250f, 0.000f}, {1, 0, 0} },
        { {  l,  l, -l }, { 0,  1, 0 }, { 0.500f, 0.000f}, {1, 0, 0} },
        { {  l,  l,  l }, { 0,  1, 0 }, { 0.500f, 0.333f}, {1, 0, 0} },
        { { -l,  l,  l }, { 0,  1, 0 }, { 0.250f, 0.333f}, {1, 0, 0} },

        // 아래(-Y) [Col 1, Row 2]  U 0.25~0.50 , V 0.666~1.000
        { { -l, -l,  l }, { 0, -1, 0 }, { 0.250f, 0.333f }, {1, 0, 0}},
        { {  l, -l,  l }, { 0, -1, 0 }, { 0.500f, 1.000f }, {1, 0, 0}},
        { {  l, -l, -l }, { 0, -1, 0 }, { 0.500f, 0.666f }, {1, 0, 0}},
        { { -l, -l, -l }, { 0, -1, 0 }, { 0.250f, 1.000f }, {1, 0, 0}},
    };
